...
export default function Footer() {
  return (
    <footer className="w-full rounded-t-[32px] bg-zinc-50 dark:bg-zinc-950">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 px-12 py-20 max-w-7xl mx-auto">
        <div className="md:col-span-2">
          ...
          <p className="text-zinc-500 dark:text-zinc-500 font-body text-sm max-w-sm leading-relaxed mb-8">
            Ένα ψηφιακό ημερολόγιο με στόχο να σε πείσει ότι ένα ταξίδι δεν
            είναι απόδραση από τη ζωή, είναι η ζωή που δεν θέλεις να χάσεις. Ελα
      ...
      {/* ── Follow Us ─────────────────────────────────────────────────────── */}
      <div className="max-w-7xl mx-auto px-12 py-12 border-t border-outline-variant/10">
        <div className="flex items-center gap-6 mb-10">
          <div className="flex-1 h-px bg-zinc-200 dark:bg-zinc-700" />
          <span className="text-[11px] font-label uppercase tracking-[0.35em] text-zinc-400">
            Βρές με στα social
          </span>
          <div className="flex-1 h-px bg-zinc-200 dark:bg-zinc-700" />
        </div>
        ...
        <div className="flex flex-col items-center gap-8">
          <div className="flex justify-center gap-12">
            <a
              ...
              aria-label="Instagram"
              className="flex flex-col items-center gap-2 text-zinc-400 hover:text-emerald-600 transition-colors"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
