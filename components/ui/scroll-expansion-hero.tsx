            ...
            <div className="flex flex-col items-center justify-center w-full h-[100dvh] relative">
              ...
              >
                ...
                <div className="flex flex-col items-center text-center relative z-10 mt-4 transition-none">
                  {date && (
                    <p
                      className="text-xl text-white/70 font-label tracking-widest uppercase"
                  ...
                  {scrollToExpand && (
                    <p
                      className="text-white/50 font-body text-sm text-center mt-2"
                      style={{ transform: `translateX(${textTranslateX}vw)` }}
                    >
                      {scrollToExpand}
                    </p>
              ...
              >
                <motion.h1
                  className="text-5xl md:text-7xl lg:text-8xl font-headline font-extrabold text-white tracking-tighter transition-none"
                  style={{ transform: `translateX(-${textTranslateX}vw)` }}
                >
                  {firstWord}
                </motion.h1>
