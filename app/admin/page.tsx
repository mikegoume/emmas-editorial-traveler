...
export default async function AdminDashboard() {
  ...
  const [{ count: destCount }, { count: regionCount }] = await Promise.all([
  ...
  return (
    <div>
      ...
      <a
        ...
        className="inline-flex items-center gap-4 bg-secondary text-on-secondary rounded-lg p-6 hover:bg-secondary-dim transition-colors"
      >
